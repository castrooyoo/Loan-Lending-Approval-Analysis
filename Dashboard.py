...
with col1:
    st.markdown("##### House ownership status by Loan default risk")
...
with col2:
    st.markdown("##### Vehicle ownership status by Loan default risk")
...
with col3:
    st.markdown("##### Marital status by Loan default risk")
...
st.markdown("##### Occupational categories by Loan default risk")
