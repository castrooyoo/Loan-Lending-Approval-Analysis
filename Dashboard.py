...
with col1:
    st.markdown("##### Loan default risk by Applicant's House ownership status")
...
with col2:
    st.markdown("##### Loan default risk by Applicant's Vehicle ownership status")
...
with col3:
    st.markdown("##### Loan default risk by Applicant's Marital status")
...
st.markdown("##### Distribution of loan default risk by applicant's occupation")
